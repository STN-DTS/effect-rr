...
/** Installs {@link loadConfigProvider} over `process.env` for everything built on top of it. */
export const EnvConfigProviderLayer = ConfigProvider.layer(loadConfigProvider(process.env));
